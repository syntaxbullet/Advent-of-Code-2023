...
const partOneExampleInput = `1abc2
pqr3stu8vwx
a1b2c3d4e5f
treb7uchet`

console.log('Part 1 Example Input:', processPartOne(partOneExampleInput));
// challenge input not pushed to repository

const partTwoExampleInput = `9dlvndqbddghpxc
...
console.log('Part 2 Example Input:', processPartTwo(partTwoExampleInput));